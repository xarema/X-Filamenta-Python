# GPT — Prompt 01: Audit sécurité/qualité + corrections

INSTRUCTIONS À GPT
- Analyse tout le repo qui t’est fourni (upload, intégration, ou copie des fichiers).
...
CONTRAINTE GPT (RÉSULTAT)
- Fournis des tableaux nets pour les vulnérabilités et un plan d’actions priorisé.
- Les correctifs doivent être livrés en patches (unified diff) + checklist de validation.