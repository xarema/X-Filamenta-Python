# Gemini — Prompt 02: Nettoyage repo + docs + .gitignore

INSTRUCTIONS À GEMINI
- Pars du contenu réel du repo. Si tu n’as pas tous les fichiers, mentionne les limites.
...
CONTRAINTE GEMINI
- Propose une arborescence cible et montre ensuite les patches (déplacements, MAJ liens, MAJ scripts/CI).
- Mets l’accent sur un `.gitignore` robuste et commenté, adapté aux langages/outils détectés.