# Gemini — Prompt 01: Audit sécurité/qualité + corrections

INSTRUCTIONS À GEMINI
- Travaille à partir du repo (workspace / fichiers importés / Git). Si tu ne vois pas tout, indique clairement la couverture.
- Commence par lire `.github/` et applique toutes les règles IA / conventions trouvées.
...
CONTRAINTE GEMINI
- Reste “grounded”: chaque constat doit avoir une preuve (fichier + ligne).
- Génère des patches unifiés pour les correctifs, puis une checklist de commandes pour valider.