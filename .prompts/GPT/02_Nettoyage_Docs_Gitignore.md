# GPT — Prompt 02: Nettoyage repo + docs + .gitignore

INSTRUCTIONS À GPT
- Analyse la structure du repo telle que fournie.
...
CONTRAINTE GPT (LIVRAISON)
- Pour la réorg, donne un plan “ancien → nouveau” + patches unifiés.
- Pour `.gitignore`, propose une version finale commentée + explique les sections.