# Claude — Prompt 01: Audit sécurité/qualité + corrections

INSTRUCTIONS À CLAUDE
- Tu as potentiellement accès à l’intégralité du repo via “Project”/fichiers fournis.
- Si tu n’as pas accès à certains fichiers, dis-le explicitement et continue avec ce que tu as; liste ce qui manque.
...
CONTRAINTE CLAUDE (QUALITÉ)
- Sois exhaustif et très concret: cite toujours fichier+ligne quand tu affirmes un problème.
- Pour chaque correction: propose un patch (unified diff) et un test de non-régression quand applicable.