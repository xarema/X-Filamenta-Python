# Claude — Prompt 02: Nettoyage repo + docs + .gitignore

INSTRUCTIONS À CLAUDE
- Si tu n’as pas accès à tout le repo, dis-le et continue avec ce que tu as.
- Priorise une organisation simple et standard, mais adaptée au projet réel.
...
CONTRAINTE CLAUDE (SÉCURITÉ & PRUDENCE)
- Toute suppression doit être “safe-by-default” et justifiée.
- Si un fichier est possiblement nécessaire, préfère l’ignorer (gitignore) et documenter.