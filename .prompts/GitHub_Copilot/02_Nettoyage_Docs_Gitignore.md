# GitHub Copilot — Prompt 02: Nettoyage repo + docs + .gitignore

CONSIGNES D’UTILISATION (Copilot Chat)
- Ouvre le dépôt dans VS Code / GitHub et utilise le contexte **@workspace**.
- Réfère-toi aux fichiers avec `#file:` quand tu proposes des modifications.
...
- Propose des diffs unifiés (`diff --git`) clairs pour les déplacements/suppressions/ajouts.
- Quand tu déplaces des fichiers, inclue aussi la mise à jour des liens et scripts impactés.